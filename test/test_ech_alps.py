...
This script uses curl_cffi to impersonate Chrome 117+ which natively
...
try:
    ...
    # Make HTTPS request with Chrome 117+ impersonation
    # This browser version includes both ECH and ALPS extensions
